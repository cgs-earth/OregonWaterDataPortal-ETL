...
assets = load_assets_from_modules([awqms, odwr, groundwater])
asset_checks = load_asset_checks_from_modules([awqms, odwr, groundwater])

definitions = Definitions(
    assets=assets,
    asset_checks=asset_checks,
    jobs=[awqms.awqms_job, odwr.odwr_job, groundwater.groundwater_job],
    schedules=[
