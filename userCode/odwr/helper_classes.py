...
def get_datastream_time_range(iotid: int) -> TimeRange:
    ...
    json = resp.json()
    assert "phenomenonTime" in json, f"phenomenonTime was not found in the datastream. This is a sign that the datastream was created in a previous call but never populated correctly. Full json: {json}"
